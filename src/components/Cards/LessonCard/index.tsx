import { linktoLesson } from "@/constants/Links";
...
export function LessonCard({id_lesson,creator,reference,resume,title}:LessonProps){
    ...
    return(
        <TouchableOpacity onPress={()=> router.push({pathname:linktoLesson,params:{id_lesson:id_lesson}})} style={{height:110, borderWidth:1, borderColor:"gray", flexDirection:"row", backgroundColor:'white', borderRadius:4, alignItems:"center", marginBottom:4}}>
            <View style={{width:82, height:80, alignItems:"center", justifyContent:"center", borderRightWidth:1, margin:8}}>
                <MaterialCommunityIcons name="book-open-variant" size={52} color="black" />
